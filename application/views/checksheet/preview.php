...
<head>
	...
	<link rel="canonical" href="https://demo-basic.Metawireco.io/" />

	<title>Metawireco</title>
        ...
        <div class="main">
            <main class="content">
                <div class="container-fluid p-0">
                    <!-- <form action="<?// base_url('add-new-checksheet')?>" method="post" enctype="multipart/form-data"> -->
                        <div class="create_form">
                            <div class="container mt-4">
                                <div class="d-flex justify-content-between align-items-center logo mb-2">
                                    <div class="inputBox mb-3">
                                        <img src="<?= base_url('assets/uploads/preview/'.$title_logo)?>" width="120px" height="100px">
                                ...
                                <div class="top">
                                    ...
                                    <div class="highlight d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="inputBox mb-3">
                                            <?= $armor_type; ?>
                                            <!-- <input type="text" name="armor_type" placeholder="Aluminum Armor" style="width: 100%" />
